...
<div class="container">
    <div class="card">
        ...
        <div class="card-header">
            <a href="<?= base_url('user/tambah'); ?>" class="btn btn-primary"><i class="fa fa-plus mr-2"></i>Tambah Data</a>
            <a href="<?= base_url('user/laporan'); ?>" target="__blank" class="btn btn-info"><i class="fa fa-print mr-2"></i>Cetak</a>
        </div>
        <!-- /.card-header -->
        <div class="card-body">
                    ...
                    foreach ($user as $row) : $no++ ?>
                        <tr>
                            ...
                            <td style="text-align: center;">
                                <a href="<?= base_url(); ?>/user/update/<?= $row['userId']; ?>" class="btn-sm btn-primary btn-update"><i class="fa fa-edit"></i></a>
                                <a class="btn-sm btn-danger btn-delete" data-toggle="modal" data-target="#deleteModal<?= $row['userId']; ?>"><i class="fa fa-trash"></i></a>
                            </td>
                        </tr>
                    <?php endforeach; ?>
                </tbody>
